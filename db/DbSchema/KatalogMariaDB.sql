...
CREATE TABLE `Books` (
  ...
  `format` enum('unknown','hardback','paperback','ebook','jacket','notebook') NOT NULL DEFAULT 'unknown',
  ...
  `size` enum('none','mini','normal','scientific','comics','huge','small','unusual') DEFAULT NULL,
