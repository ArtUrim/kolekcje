    ...
    return [
      {
        ...
        headerColor: 'primary',
        shortText: bookData?.title || '',
        expandedText: bookData?.original_title || '',
        expanded: false,
      },
      {
        title: 'Authors',
        ...
        shortText: bookData?.authors || '',
        expandedText: bookData?.authors || '',
      ...
      },
      {
        ...
        icon: 'mdi-domain',
        headerColor: 'info',
        shortText: bookData?.publishers || '',
        expandedText: bookData?.publishers || '',
      ...
      },
      {
        ...
        headerColor: 'teal',
        shortText: bookData?.series_name || '',
        expandedText: bookData?.series_name || '',
        expanded: false,
      },
    ]
  }
    ...
    return [
      {
        ...
        headerColor: 'orange',
        shortText: bookData?.description || '',
        expandedText: bookData?.description || '',
        expanded: false,
      },
      {
        title: 'Details',
        ...
        headerColor: 'indigo',
        shortText: `ISBN: ${bookData?.isbn || ''} | Pages: ${bookData?.pages || ''} | Year: ${bookData?.release_date || ''}`,
        expandedText: `First Polish Release: ${bookData?.first_polish_release_date || ''} | Format: ${bookData?.format || ''} | Language: ${bookData?.language_name || ''} | Translator: ${bookData?.translator || ''} | Size: ${bookData?.size || ''}`,
      ...
      },
      {
        ...
        headerColor: 'pink',
        shortText: bookData?.note || '',
        expandedText: bookData?.note || '',
